import { c as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, b as reactIsExports, d as React, A as Animate } from "./chunk-dJI1vi8Z.js";
function r(e) {
  var t, f, n = "";
...
var isArguments$3 = baseIsArguments(/* @__PURE__ */ function() {
  ...
  return isObjectLike$4(value) && hasOwnProperty$5.call(value, "callee") && !propertyIsEnumerable.call(value, "callee");
};
...
var baseMatches = _baseMatches, baseMatchesProperty = _baseMatchesProperty, identity$9 = identity_1, isArray$5 = isArray_1, property = property_1;
...
var constant$1 = constant_1, defineProperty$1 = _defineProperty$z, identity$7 = identity_1;
...
var DecimalCSS = /* @__PURE__ */ function() {
  ...
  return _createClass$d(DecimalCSS2, [{
    ...
    value: function parse(str) {
      ...
      var _ref = (_NUM_SPLIT_REGEX$exec = NUM_SPLIT_REGEX.exec(str)) !== null && _NUM_SPLIT_REGEX$exec !== void 0 ? _NUM_SPLIT_REGEX$exec : [], _ref2 = _slicedToArray$7(_ref, 3), numStr = _ref2[1], unit2 = _ref2[2];
...
function transformer$2() {
  var domain = unit, range3 = unit, interpolate$1 = interpolate, transform, untransform, unknown, clamp = identity$5, piecewise2, output, input;
  function rescale() {
...
function transformer$1() {
  var x0 = 0, x1 = 1, t02, t12, k10, transform, interpolator = identity$5, clamp = false, unknown;
  function scale(x2) {
...
function transformer() {
  var x0 = 0, x1 = 0.5, x2 = 1, s2 = 1, t02, t12, t2, k10, k21, interpolator = identity$5, transform, clamp = false, unknown;
  function scale(x3) {
...
var baseExtremum$1 = _baseExtremum, baseGt = _baseGt, identity$2 = identity_1;
function max(array2) {
  return array2 && array2.length ? baseExtremum$1(array2, identity$2, baseGt) : void 0;
}
var max_1 = max;
...
var baseExtremum = _baseExtremum, baseLt = _baseLt, identity$1 = identity_1;
function min(array2) {
